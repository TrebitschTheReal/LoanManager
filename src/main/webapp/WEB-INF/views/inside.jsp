...
<div class="inner-body">
    ...
    <div class="p-5 m-5">
        <div class="row">
            <a href="inside/admin" class="mx-2 col btn btn-success">To Admin</a>
            <a href="inside/manager" class="mx-2 col btn btn-primary">To Manager</a>
            <a href="inside/user" class="mx-2 col btn btn-secondary">To User</a>
        </div>
